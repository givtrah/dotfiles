...
vim.opt.guicursor = "n-v-c:block,i-ci-ve:block,r-cr:hor20,o:hor50,a:blinkwait700-blinkoff400-blinkon250-Cursor/lCursor,sm:block-blink-blinkwait175-blinkoff150-blinkon175" -- cursor blinking and settings
...
-- KEYMAPS
-- ============================================================================
-- Set <space> as leader key, must happen before plugins are loaded (source?)
...
-- parts of the config are from: https://github.com/radleylewis/nvim-lite/blob/master/init.lua
